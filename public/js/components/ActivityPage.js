...
let mar2014 = require('../../../json_files/steps/march2014Steps.json')["step-counter"]["dataset"];
let apr2014 = require('../../../json_files/steps/april2014Steps.json')["step-counter"]["dataset"];
let may2014 = require('../../../json_files/steps/may2014Steps.json')["step-counter"]["dataset"];
let jun2014 = require('../../../json_files/steps/june2014Steps.json')["step-counter"]["dataset"];
let jul2014 = require('../../../json_files/steps/july2014Steps.json')["step-counter"]["dataset"];
let aug2014 = require('../../../json_files/steps/august2014Steps.json')["step-counter"]["dataset"];
let sep2014 = require('../../../json_files/steps/september2014Steps.json')["step-counter"]["dataset"];
let oct2014 = require('../../../json_files/steps/october2014Steps.json')["step-counter"]["dataset"];
let nov2014 = require('../../../json_files/steps/november2014Steps.json')["step-counter"]["dataset"];
let dec2014 = require('../../../json_files/steps/december2014Steps.json')["step-counter"]["dataset"];

let jan2015 = require('../../../json_files/steps/january2015Steps.json')["step-counter"]["dataset"];
let feb2015 = require('../../../json_files/steps/february2015Steps.json')["step-counter"]["dataset"];
let mar2015 = require('../../../json_files/steps/march2015Steps.json')["step-counter"]["dataset"];
let apr2015 = require('../../../json_files/steps/april2015Steps.json')["step-counter"]["dataset"];
let may2015 = require('../../../json_files/steps/may2015Steps.json')["step-counter"]["dataset"];
let jun2015 = require('../../../json_files/steps/june2015Steps.json')["step-counter"]["dataset"];
let jul2015 = require('../../../json_files/steps/july2015Steps.json')["step-counter"]["dataset"];
let aug2015 = require('../../../json_files/steps/august2015Steps.json')["step-counter"]["dataset"];
let sep2015 = require('../../../json_files/steps/september2015Steps.json')["step-counter"]["dataset"];
let oct2015 = require('../../../json_files/steps/october2015Steps.json')["step-counter"]["dataset"];
let nov2015 = require('../../../json_files/steps/november2015Steps.json')["step-counter"]["dataset"];
let dec2015 = require('../../../json_files/steps/december2015Steps.json')["step-counter"]["dataset"];

let jan2016 = require('../../../json_files/steps/january2016Steps.json')["step-counter"]["dataset"];
let feb2016 = require('../../../json_files/steps/february2016Steps.json')["step-counter"]["dataset"];
let mar2016 = require('../../../json_files/steps/march2016Steps.json')["step-counter"]["dataset"];
let apr2016 = require('../../../json_files/steps/april2016Steps.json')["step-counter"]["dataset"];
let may2016 = require('../../../json_files/steps/may2016Steps.json')["step-counter"]["dataset"];
let jun2016 = require('../../../json_files/steps/june2016Steps.json')["step-counter"]["dataset"];
let jul2016 = require('../../../json_files/steps/july2016Steps.json')["step-counter"]["dataset"];
let aug2016 = require('../../../json_files/steps/august2016Steps.json')["step-counter"]["dataset"];
let sep2016 = require('../../../json_files/steps/september2016Steps.json')["step-counter"]["dataset"];
let oct2016 = require('../../../json_files/steps/october2016Steps.json')["step-counter"]["dataset"];
let nov2016 = require('../../../json_files/steps/november2016Steps.json')["step-counter"]["dataset"];
let dec2016 = require('../../../json_files/steps/december2016Steps.json')["step-counter"]["dataset"];

let jan2017 = require('../../../json_files/steps/january2017Steps.json')["step-counter"]["dataset"];
let feb2017 = require('../../../json_files/steps/february2017Steps.json')["step-counter"]["dataset"];
let mar2017 = require('../../../json_files/steps/march2017Steps.json')["step-counter"]["dataset"];
let apr2017 = require('../../../json_files/steps/april2017Steps.json')["step-counter"]["dataset"];
let may2017 = require('../../../json_files/steps/may2017Steps.json')["step-counter"]["dataset"];
let jun2017 = require('../../../json_files/steps/june2017Steps.json')["step-counter"]["dataset"];
let jul2017 = require('../../../json_files/steps/july2017Steps.json')["step-counter"]["dataset"];
let aug2017 = require('../../../json_files/steps/august2017Steps.json')["step-counter"]["dataset"];
let sep2017 = require('../../../json_files/steps/september2017Steps.json')["step-counter"]["dataset"];
let oct2017 = require('../../../json_files/steps/october2017Steps.json')["step-counter"]["dataset"];
let nov2017 = require('../../../json_files/steps/november2017Steps.json')["step-counter"]["dataset"];
let dec2017 = require('../../../json_files/steps/december2017Steps.json')["step-counter"]["dataset"];
...
export default class ActivityPage extends React.Component{
	...
	selected(){
		...
		{
			return (<h1>On the {this.state.x}st, {this.state.user.firstName} took {this.state.y} steps</h1>);
		} else if( this.state.x == 2 || this.state.x == 22 )
		{
			return (<h1>On the {this.state.x}nd, {this.state.user.firstName} took {this.state.y} steps</h1>);
		} else if( this.state.x == 3 || this.state.x == 23 )
		{
			return (<h1>On the {this.state.x}rd, {this.state.user.firstName} took {this.state.y} steps</h1>);
		} else
		{
			return (<h1>On the {this.state.x}th, {this.state.user.firstName} took {this.state.y} steps</h1>);
		}
