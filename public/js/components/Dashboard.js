...
return(
    <div class="container">
        <div class="row">
            ...
            <Tile3 linkTo={"/"+ this.state.user.firstName + "/symptom"} image="http://is1.mzstatic.com/image/thumb/Purple127/v4/17/b0/bc/17b0bc22-6ff3-b5e3-8b3d-bfe08b5ad016/mzl.rcqmzuse.png/100x100bb-85.png" name='Symptoms'/>
            <Tile3 linkTo={"/"+ this.state.user.firstName + "/activity"} image="http://www.hegroup.org.uk/images/expertise_icons/activity-icon.gif" name='Activity'/>     
