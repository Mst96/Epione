...
return(
    <div class="container">
        <div class="row">
            ...
            <Tile linkTo={"/profile/" + this.state.user.firstName} image="https://static0.fitbit.com/images/profile/defaultProfile_100_male.png" name='Profile' line1={this.state.user.firstName} line2={this.state.user.age}/>
            ...
            <Tile linkTo={"/settings"} image="https://png.icons8.com/?id=47054&size=2x" name='Settings'/>
        </div>
    </div>
        );
}
