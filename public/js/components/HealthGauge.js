...
let bodymassindex = require('../../../json_files/bmi.json');
...
let respiratoryrate = require('../../../json_files/respiratory.json');
...
let bodymassindex = require('../../../json_files/gaugeData.json')['dataset']['bmi'];
...
let respiratoryrate = require('../../../json_files/gaugeData.json')['dataset']['rr'];
let steps = require('../../../json_files/gaugeData.json')['dataset']['steps'];
let weight = require('../../../json_files/gaugeData.json')['dataset']['weight'];
let sleep = require('../../../json_files/gaugeData.json')['dataset']['sleep'];
